<div class="sticky top-[180px] hidden lg:col-span-3 lg:block space-y-2 h-fit pb-20">
    ...
    <div>
        <div class="flex mb-4 mt-6">
            <h1 class="font-bold text-slate-900 border-b-[3px] border-green-600">BANNER LIÊN KẾT </h1>
            <div class="flex-1 border-b-[3px] border-slate-900/40"></div>
        </div>
        <div class="space-y-2">
            <a class="block" href="/bantinattp">
                <img src="{{asset('images/a-min.jpg')}}" alt="" class="w-full">
            </a>
            <a class="block" href="/bantinattp">
                <img src="{{asset('images/d-min.jpg')}}" alt="" class="w-full">
            </a>
            <a class="block" href="/bantinattp">
                <img src="{{asset('images/e-min.jpg')}}" alt="" class="w-full">
            </a>
        </div>
    </div>
