  ...
  public function showPageManageLicense(Request $request)
  {
    ...
    if ($request->month_option === null) {
      $getList = KeHoachThanhTra::join('ketquathanhtra', 'ketquathanhtra.maKHTT', '=', 'kehoachthanhtra.maKHTT')
        ...
        ->get([
          'cosokinhdoanh.tenCSKD', 'cosokinhdoanh.maCSKD', 'giayphepattp.maGiayPhepATTP',  'ketquathanhtra.ketQuaThanhTra',
    ...
    return view('admin/pages/manageLicense')->with(compact('getList'))
      ->with(compact('arr'));
  }
